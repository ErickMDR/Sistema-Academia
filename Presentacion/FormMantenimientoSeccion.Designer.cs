...
{
    partial class FormMantenimientoSeccion
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            panelInfo.Controls.Add(txtseccion);
            ...
            txtseccion.MaxLength = 20;
            txtseccion.Name = "txtseccion";
            txtseccion.PlaceholderText = "Sección";
            txtseccion.ShortcutsEnabled = false;
            txtseccion.Size = new Size(184, 37);
            ...
            title.TabIndex = 2;
            title.Text = "MANTENIMIENTO SECCIÓN";
            // 
            // FormMantenimientoSeccion
            // 
            AutoScaleDimensions = new SizeF(8F, 19F);
            AutoScaleMode = AutoScaleMode.Font;
            ClientSize = new Size(1902, 845);
            Controls.Add(panelInfo);
            Name = "FormMantenimientoSeccion";
            Text = "Mantenimiento Sección";
